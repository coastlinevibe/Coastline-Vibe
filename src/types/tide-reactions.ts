  ...
  reactions: [
    {
      ...
      name: 'LOL',
      type: 'static',
      url: 'https://kbjudvamidagzzfvxgov.supabase.co/storage/v1/object/public/reactions/lol.png',
    },
    {
      code: 'angry',
      name: 'Angry',
      type: 'static',
      url: 'https://kbjudvamidagzzfvxgov.supabase.co/storage/v1/object/public/reactions/angry.png',
    },
    {
      code: 'love',
      name: 'Love',
      type: 'static',
      url: 'https://kbjudvamidagzzfvxgov.supabase.co/storage/v1/object/public/reactions/love.png',
    },
    {
      code: 'like',
      name: 'Like',
      type: 'static',
      url: 'https://kbjudvamidagzzfvxgov.supabase.co/storage/v1/object/public/reactions/like.png',
    },
    {
      code: 'wow',
      name: 'Wow',
      type: 'static',
      url: 'https://kbjudvamidagzzfvxgov.supabase.co/storage/v1/object/public/reactions/wow.png',
    },
  ],
};
