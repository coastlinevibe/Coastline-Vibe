  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sand: "#F5F5DC",  // Adding sand color (beige)
        darkCharcoal: "#333333", // Adding dark charcoal for text
        primaryTeal: "#008080", // Teal color
        offWhite: "#F9F9F9", // Off-white color
        seafoam: "#7FFFD4", // Seafoam color
        gray: {
          50: '#f9fafb',
          100: '#f3f4f6',
          200: '#e5e7eb',
      ...
      maxWidth: {
        'content': '1200px', // Max width for content
      },
      boxShadow: {
